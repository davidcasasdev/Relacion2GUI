...
public class Ejercicio8_v2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ejercicio8_v2 frame = new Ejercicio8_v2();
	...
	public Ejercicio8_v2() {
		...
		rdbYenes1.setActionCommand("yenes");
		...
		rdbDolar2.setActionCommand("dolares");
		...
		rdbEuros2.setActionCommand("euros");
		...
		rdbYenes2.setActionCommand("yenes");
...
//		);
		...
		String moneda1 =grupo1.getSelection().getActionCommand();
		String moneda2 =grupo2.getSelection().getActionCommand();
		...
		if (moneda1.equals("dolares")) {
			if (moneda2.equals("euros")) {
				cambio=cantidad*DOLARAEURO;				
			} else if (moneda2.equals("yenes")) {
				cambio=cantidad*DOLARAYEN;	
				moneda="¥";
			}
		} else if (moneda1.equals("euros")) {
			if (moneda2.equals("dolares")) {
				cambio=cantidad*EUROADOLAR;	
				moneda="$";
			} else if (moneda2.equals("yenes")) {
				cambio=cantidad*EUROAYEN;
				moneda="¥";
			}
		} else {
			if (moneda2.equals("dolares")) {
				cambio=cantidad*YENADOLAR;
				moneda="$";
			} else if (moneda2.equals("euros")) {
				cambio=cantidad*YENAEURO;				
			}
		}
		lblConversion.setText(String.format("%.2f "+moneda, cambio));
	}
}
